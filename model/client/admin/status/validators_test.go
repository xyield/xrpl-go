...
func TestValidatorsResponse(t *testing.T) {
	s := ValidatorsResponse{
		LocalStaticKeys: []string{},
		PublisherLists: []PublisherList{
			{
				...
				PubkeyPublisher: "ED2677ABFFD1B33AC6FBC3062B71F1E8397C1505E1C42C64D11AD1B28FF73F4734",
				Seq:             70,
				Version:         1,
			},
		},
